...
import UserInterface.SnakeGame.SnakeGame;
...
public class AdminMainInterfaceController extends CommonMethods implements Initializable {
    ...
    @FXML
    AnchorPane holderPane, mainPane, windowPane;
    ...
    public AdminMainInterfaceController(String username) {
    ...
    void goToOption(ActionEvent event) {
        ...
        try {
            loader.setController(new OptionController(username));
            holderPane.getChildren().add((Node) loader.load());
