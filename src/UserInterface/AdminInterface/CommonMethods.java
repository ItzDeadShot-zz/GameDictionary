...
public class CommonMethods {
    ...
    public static boolean succConfirmed=false;  //used in successful signup
    public static boolean deleteConfirmed=false; //used in deleting game
    ...
    public void logOut(ActionEvent event){
        ...
        try {
            Parent parent = FXMLLoader.load(getClass().getResource("../../resources/fxml/LogoutConfirmation.fxml"));
    ...
    /**
     *  Loads a new popup window allow the user to go
     *  to the sign in screen.
     * @param event The button which triggered the event
     */
    public void loadSuccessfulPopup(ActionEvent event){
        succConfirmed = false;
        Node source = (Node) event.getSource();
        Stage stage = (Stage) source.getScene().getWindow();
        AnchorPane mainpane= (AnchorPane) ((Node) event.getSource()).getParent().getParent();
        mainpane.setEffect(new ColorAdjust(0,0,-0.25,0));
        try {
            Parent parent = FXMLLoader.load(getClass().getResource("../../resources/fxml/SuccessfulSignUp.fxml"));
            Stage popup = new Stage();
            Scene scene=new Scene(parent);
    ...
    public void loadSuccessfulManageGame(AnchorPane pane, ActionEvent event){
        succConfirmed = false;
        Node source = (Node) event.getSource();
        Stage stage = (Stage) source.getScene().getWindow();
        AnchorPane mainpane= (AnchorPane) ((Node) event.getSource()).getParent().getParent();
        mainpane.setEffect(new ColorAdjust(0,0,-0.25,0));
        try {
            Parent parent = FXMLLoader.load(getClass().getResource("../../resources/fxml/SuccessfulAddGame.fxml"));
            Stage popup = new Stage();
            Scene scene=new Scene(parent);
    ...
    public boolean onDeleteConfirmed(MouseEvent event){
        Node source = (Node) event.getSource();
        Stage stage = (Stage) source.getScene().getWindow();
        try {
            Parent parent = FXMLLoader.load(getClass().getResource("../../resources/fxml/DeleteConfirmation.fxml"));
            Stage popup = new Stage();
            Scene scene=new Scene(parent);
